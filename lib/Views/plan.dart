...
class MembersshipsPlan extends StatefulWidget {
  const MembersshipsPlan({super.key});

  @override
  State<MembersshipsPlan> createState() => _MembersState();
}

class _MembersState extends State<MembersshipsPlan> {
  int? selected;

  var header = <MemberHeader>[
    MemberHeader(text: 'Plan ID'),
    MemberHeader(text: 'Plan Name'),
    MemberHeader(text: 'Duration'),
    MemberHeader(text: 'Monthly Fee'),
    MemberHeader(text: 'Descripton'),
  ];
  ...
  Future<Object?> input(ui.BuildContext context, {MemberData? data}) {
    if (data != null) {
      ...
      child: SingleChildScrollView(
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            member!.removeWhere(
              (element) =>
                  element.planId!.contains(_search.text.toUpperCase()) == false,
            );
            return DataTable(
                ...
                (index) {
                  ...
                  return DataRow(
                    cells: [
                      ...
                      DataCell(Text(data.durationDays!.toString())),
                      DataCell(Text(data.monthlyFee!.toString())),
