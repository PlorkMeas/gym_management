...
class Schedule extends StatefulWidget {
  ...
  @override
  State<Schedule> createState() => _MembersState();
}

class _MembersState extends State<Schedule> {
  int? selected;
  ...
  var header = <MemberHeader>[
    ...
    MemberHeader(text: 'Capacity'),
    MemberHeader(text: 'Date'),
    MemberHeader(text: 'Description'),
    MemberHeader(text: ''),
  ];
      ...
      child: SingleChildScrollView(
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            member!.removeWhere(
              (element) =>
                  element.classId!.contains(_search.text.toUpperCase()) ==
                  false,
            );
            return DataTable(
                ...
                (index) {
                  ...
                  return DataRow(
                    cells: [
                      ...
                      DataCell(Text(data.maxCapacity!.toString())),
                      DataCell(Text(data.classDate!)),
