...
class Instructor extends StatefulWidget {
  ...
  @override
  State<Instructor> createState() => _MembersState();
}

class _MembersState extends State<Instructor> {
  int? selected;

  var header = <MemberHeader>[
    MemberHeader(text: 'Instructor ID'),
    MemberHeader(text: 'First Name'),
    MemberHeader(text: 'Last Name'),
    MemberHeader(text: 'Gender'),
    MemberHeader(text: 'Specialties'),
    MemberHeader(text: ''),
  ];
      ...
      child: SingleChildScrollView(
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            member!.removeWhere(
              (element) =>
                  element.instructorId!.contains(_search.text.toUpperCase()) ==
                  false,
            );
            return DataTable(
                ...
                (index) {
                  ...
                  return DataRow(
                    cells: [
                      ...
                      DataCell(Text(data.specialties!)),
                      DataCell(Row(
                                ...
                                builder: (context) => ui.ContentDialog(
                                  ...
                                  actions: [
                                    ui.FilledButton(
                                      ...
                                      onPressed: () async {
                                        await Data.deleteInstructor(data);
                                        _refresh();
                                        // ignore: use_build_context_synchronously
                                        Navigator.pop(context);
                                      },
